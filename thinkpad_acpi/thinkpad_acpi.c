...
/** \file thinkpad_acpi.c
 * The source for the thinkpad acpi.
 * \seealso thinkpad_acpi.h
 */
...
/**
 * \brief The set of leds controlled by the thinkpad acpi.
 *
 * A pointer to the first led in the set controlled by tpacpi. Following this
 * are adjacent pointers to the rest of the leds. Note that there are a total of
